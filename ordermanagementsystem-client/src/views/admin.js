    ...
    <div className="admin-container">
      ...
      <header data-role="Header" className="admin-header">
          ...
          <div className="admin-container2">
            <div className="admin-nav">
              <nav className="admin-nav1">
                ...
                <span className="admin-text01">Managers</span>
        ...
        <div className="admin-container3">
          ...
          <Link to="/" className="admin-book button button-main">
        ...
        <div data-role="BurgerMenu" className="admin-burger-menu">
          <svg viewBox="0 0 1024 1024" className="admin-icon">
        ...
        <div data-role="MobileMenu" className="admin-mobile-menu">
          <nav className="admin-nav2">
            <div className="admin-container5">
              <img
                alt="image"
              ...
              >
                <svg viewBox="0 0 1024 1024" className="admin-icon02">
          ...
          <div>
            <svg viewBox="0 0 950.8571428571428 1024" className="admin-icon04">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="admin-icon06">
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="admin-icon08">
              <path d="M548 6.857v150.857h-89.714c-70.286 0-83.429 33.714-83.429 82.286v108h167.429l-22.286 169.143h-145.143v433.714h-174.857v-433.714h-145.714v-169.143h145.714v-124.571c0-144.571 88.571-223.429 217.714-223.429 61.714 0 114.857 4.571 130.286 6.857z"></path>
            </svg>
          </div>
        </div>
      </header>
      <section id="register" className="admin-register">
