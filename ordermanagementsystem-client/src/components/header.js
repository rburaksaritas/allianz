  ...
  return (
    <header data-role="Header" className="header-header">
        ...
        <div className="header-container1">
          <div className="header-nav">
            <nav className="header-nav1">
              ...
              <span className="header-text1">{props.text11}</span>
              <span className="header-text2">{props.text21}</span>
              <span className="header-text3">{props.text31}</span>
              <span className="header-text4">{props.text41}</span>
            </nav>
          </div>
        </div>
      </div>
      <div className="header-container2">
        ...
        <a href="#register" className="header-book button button-main">
...
Header.defaultProps = {
  pastedImage_alt: 'allianzlogo',
  pastedImage_src: '/external/pastedimage-75g2.svg',
  text11: 'Managers',
  text21: 'Orders',
  text31: 'Managers',
  text7: 'Users',
